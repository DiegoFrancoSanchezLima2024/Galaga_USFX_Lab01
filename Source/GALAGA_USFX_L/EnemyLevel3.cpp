...
AEnemyLevel3::AEnemyLevel3()
{
	...
	static ConstructorHelpers::FObjectFinder<UStaticMesh> MeshAsset(TEXT("StaticMesh'/Game/TwinStick/Meshes/EnemyLevel3.EnemyLevel3'"));
...
void AEnemyLevel3::Damage(float Damage)
{
	Life -= Damage;
}
...
void AEnemyLevel3::ComponenteDeDestruccion()
{
	if (Explosion_Nave)
