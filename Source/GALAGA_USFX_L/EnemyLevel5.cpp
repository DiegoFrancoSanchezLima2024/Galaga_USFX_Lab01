...
AEnemyLevel5::AEnemyLevel5()
{
	...
	static ConstructorHelpers::FObjectFinder<UStaticMesh> MeshAsset(TEXT("StaticMesh'/Game/TwinStick/Meshes/EnemyLevel5.EnemyLevel5'"));
...
void AEnemyLevel5::Damage(float Damage)
{
	Life -= Damage;
}
...
void AEnemyLevel5::ComponenteDeDestruccion()
{
	if (Explosion_Nave)
