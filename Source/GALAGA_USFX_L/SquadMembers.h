...
#include "SquadMembers.generated.h"

// This class does not need to be modified.
UINTERFACE(MinimalAPI)
class USquadMembers : public UInterface
{
	GENERATED_BODY()
};

class GALAGA_USFX_L_API ISquadMembers
{
	GENERATED_BODY()
...
public:
    ...
    virtual void SetMesh(UStaticMeshComponent* MeshSquad) = 0;
